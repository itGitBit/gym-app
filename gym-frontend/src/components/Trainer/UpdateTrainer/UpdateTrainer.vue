    ...
    <div class="main">
        ...
        <div v-if="isEditting" class="edit-form">
            ...
            <form @submit.prevent="onSubmitForm" class="edit-form">
                ...
                <input class="edit-field" type="text" id="name" v-model="trainer.name" />
                <label class="edit-field" for="email">Email:</label>
                <input class="edit-field" type="email" id="email" v-model="trainer.email" />
                <label class="edit-field" for="phone">Phone:</label>
                <input class="edit-field" type="tel" id="phone" v-model="trainer.phone" />
